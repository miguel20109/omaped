...
const hot = new Handsontable(container, {
  ...
  nestedHeaders: [
	  [{ label: 'Solicitud', colspan: 3 }, { label: 'Expediente', colspan: 2 }, { label: 'Comprobante de pago', colspan: 2 }],
	  ['ID', 'Numero', 'DNI', 'Numero', 'Fecha', 'Numero', 'Fecha'],
  ],
  filters: true,
...
function getData() {
	...
	fetch('http://172.16.18.13/ruos/public/exceleditor/listarsolicitudes/'+cbtramite+'/'+cbmes+'/'+cbanio).then((response) => {
...
save.addEventListener('click', () => {
	...
	$.ajax({
		url: 'http://172.16.18.13/ruos/public/exceleditor/guardarsolicitudes/'+data,
		type: 'get',
		dataType: 'json',
		contentType: 'application/json',
		success: function (data) {
