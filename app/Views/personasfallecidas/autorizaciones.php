...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-lg-2">
                <a href="javascript:void(0);" onclick="ListarAutorizaciones();" class="btn btn-success">Buscar</a>
            </div>
            <div class="form-group col-lg-2">
...
<?= $this->section('js'); ?>
<script src="<?php echo base_url('assets/js/pages/personas-fallecidas-autorizaciones.js'); ?>"></script>
<?= $this->endSection('js'); ?>