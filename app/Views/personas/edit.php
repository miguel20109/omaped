                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="cbregion" name="cbregion" class="form-control form-select">
                        ...
                        <?php foreach ($cbregion as $row) { ?>
                            <option value="<?php echo $row['ID']; ?>" <?= set_select('cbregion', $row['ID'], ($persona['region'] == $row['ID'] || $row == $row['ID'] ? true : false)) ?>>
                                <?php echo $row['region']; ?>
                            </option>
                        <?php } ?>
                    </select>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="cbprovincia" name="cbprovincia" class="form-control form-select">
                        ...
                        <?php foreach ($cbprovincia as $row) { ?>
                            <option value="<?php echo $row['ID']; ?>" <?= set_select('cbprovincia', $row['ID'], ($persona['provincia'] == $row['ID'] || $row == $row['ID'] ? true : false)) ?>>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="cbdistrito" name="cbdistrito" class="form-control form-select">
                        ...
                        <?php foreach ($cbdistrito as $row) { ?>
                            <option value="<?php echo $row['ID']; ?>" <?= set_select('cbdistrito', $row['ID'], ($persona['distrito'] == $row['ID'] || $row == $row['ID'] ? true : false)) ?>>
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo set_value('referencia', $persona['referencia']); ?>" placeholder="" id="referencia" name="referencia" class="form-control">
                        </div>
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (data.length > 0) {
						...
						$('#cbdistrito').html("<option value='0'>Seleccionar</option>");
					}
				}
			});
