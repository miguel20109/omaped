...
class PersonasfallecidasController extends BaseController
{

    private $fallecidos, $persona, $roles, $reglas, $session, $cementerios, $lugar, $ubicacion, $ubicacionhistorial, $sepultura, $tramite, $correlativo, $ordenes, $solicitud, $autorizaciones, $usuarios, $meses, $anios;
    ...
    public function declarar($dni, $declarante, $fecha)
    {
        ...
        // }
        /*
        return redirect()->to(base_url('personasfallecidas/' . $dni . '/edit'))->with('respuesta', [
            'type' => 'success',
    ...
    public function edit($idPersona)
    {
        ...
        /*
		$this->fallecidos->select("a.dni, IDdeclarante, IDcementerio, IDlugar, procedencia, concat(a.apaterno,' ',a.amaterno,' ',a.nombres) as declarante");
		$data['fallecidos'] = $this->fallecidos->join('personas as a', 'personas_fallecidas.dni = a.dni')->where('a.dni', $idPersona)->first();
		*/
