...
/*
    public function demo()
    {
        ...
        require $_SERVER['DOCUMENT_ROOT'] . '/ruos/vendor/autoload.php';
        $input = $_SERVER['DOCUMENT_ROOT'] . '/ruos/vendor/lavela/phpjasper/examples/hello_world.jrxml';   
  ...
  /* 
        ...
        $input = $_SERVER['DOCUMENT_ROOT'] . '/ruos/public/reportes/FICHA_RUOS.jrxml';
...
/*
        ...
        $input = $_SERVER['DOCUMENT_ROOT'] . '/ruos/public/reportes/FICHA_RUOS.jrxml';   
        $output = $_SERVER['DOCUMENT_ROOT'] . '/ruos/public/reportes';
        $jdbc_dir = $_SERVER['DOCUMENT_ROOT'] . '/ruos/vendor/lavela/phpjasper/bin/jaspertarter/jdbc';
        $options = [
            'format' => ['pdf'],
            'locale' => 'US',
            'params' => ['idorganizacion'=>'002568','REPORT_URL_IMG '=>'http://172.16.18.239/ruos/public/'],
            'db_connection' => [
                'driver' => 'mysql',
                'host' => '127.0.0.1',
                'port' => '3306',
                ...
                'jdbc_url' => 'jdbc:mysql://localhost/db_ruos',
                'jdbc_dir' => $jdbc_dir
            ]
        ];
